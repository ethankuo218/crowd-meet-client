...
export class SignUpPage implements OnInit {
  ...
  constructor(
    ...
    this.matching_passwords_group = new UntypedFormGroup({
      ...
      return PasswordValidator.areNotEqual(formGroup as UntypedFormGroup);
    });
  ...
  public async signUpWithEmail(): Promise<void> {
    ...
    try {
      await this.authService.signUpWithEmail(this.signupForm.value['email'], this.signupForm.value.matching_passwords.password)
      .then((result) => {
        this.redirectLoggedUserToProfilePage();
      })
      .catch((error) => {
